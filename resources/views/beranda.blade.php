...
<body class="font-sans text-gray-800">
    ...
    <header class="bg-green-600 text-white shadow">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                ...
                <nav class="hidden md:flex space-x-6">
                    <a href="#" class="text-white-600 hover:text-gray-600">Beranda</a>
        ...
        <div id="mobile-menu" class="md:hidden hidden px-4 pb-4">
            <a href="#" class="block py-2 text-gray-600 hover:text-blue-600">Beranda</a>
    ...
    <section class="relative bg-cover bg-center bg-no-repeat h-screen" style="background-image: url('{{ asset('storage/siswa_madrasah.jpeg') }}')">
        ...
        <div class="relative z-10 flex items-center justify-center h-full text-center px-4">
            <div>
                ...
                <a href="{{route('masuk')}}" class="inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-300">
                    Daftar Sekarang
                </a>

...
<body class="font-sans text-gray-800">
    ...
    <header class="bg-green-600 text-white shadow">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                <div class="text-2xl font-bold text-white-600">MAN BONTANG</div>
                <nav class="hidden md:flex space-x-6">
                    <a href="{{route('welcome')}}" class="text-white-600 hover:text-gray-600">Beranda</a>
                    <a href="#jadwal" class="text-white-600 hover:text-gray-600">Jadwal</a>
                    <a href="#syarat" class="text-white-600 hover:text-gray-600">Syarat</a>
                    <a href="#alur" class="text-white-600 hover:text-gray-600">Alur</a>
                    <a href="#kontak" class="text-white-600 hover:text-gray-600">Kontak</a>
                    <a href="{{route('pengumuman')}}" class="text-white-600 hover:text-gray-600">Pengumuman</a>
                </nav>
                <div class="md:hidden">
                    <button id="menu-btn" class="text-gray-600 hover:text-blue-600 focus:outline-none">☰</button>
                </div>
            </div>
        </div>
        <!-- Mobile Menu -->
        <div id="mobile-menu" class="md:hidden hidden px-4 pb-4">
            <a href="{{route('welcome')}}" class="block py-2 text-gray-600 hover:text-blue-600">Beranda</a>
            <a href="#jadwal" class="block py-2 text-gray-600 hover:text-blue-600">Jadwal</a>
            <a href="#syarat" class="block py-2 text-gray-600 hover:text-blue-600">Syarat</a>
            <a href="#alur" class="block py-2 text-gray-600 hover:text-blue-600">Alur</a>
            <a href="#kontak" class="block py-2 text-gray-600 hover:text-blue-600">Kontak</a>
            <a href="{{route('pengumuman')}}" class="block py-2 text-gray-600 hover:text-blue-600">Pengumuman</a>
        </div>
    </header>
    ...
    <section id="kontak" class="py-16 bg-white">
        <div class="max-w-4xl mx-auto px-4 text-center">
            ...
            <p class="mb-2">📍 Jl. Kapten Pierre Tendean RT 19 No 20 Kec. Bontang Utara, Kota Bontang</p>
            <p class="mb-2">📱 081256871610</p>
            <p>📧 info@manbontang.sch.id</p>

            <a href="https://wa.me/6285250403177?text=Halo%20Admin%20PPDB%2C%20saya%20ingin%20bertanya%20mengenai%20pendaftaran."
                target="_blank"
